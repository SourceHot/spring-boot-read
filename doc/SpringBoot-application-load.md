...
2. 全局搜索yml
   ...
   ![image-20200319083048849](assets/image-20200319083048849.png)

3. 换成`properties`搜索

   ![image-20200319083140225](assets/image-20200319083140225.png)
...
![image-20200319083345067](assets/image-20200319083345067.png)
...
![image-20200319082131146](assets/image-20200319082131146.png)

![image-20200319082544653](assets/image-20200319082544653.png)
...
- 熟悉的老朋友`this.propertySourceLoaders = SpringFactoriesLoader.loadFactories(PropertySourceLoader.class,      getClass().getClassLoader())`， 看看**`spring.factories`**有什么
  ...
  - 搜索目标: `org.springframework.boot.env.PropertySourceLoader`
    ...
    ![image-20200319084141748](assets/image-20200319084141748.png)



![image-20200319084151997](assets/image-20200319084151997.png)

观察发现里面有一个`YamlPropertySourceLoader`和我们之前找yml字符串的时候找到的类是一样的。说明搜索方式没有什么问题。

![image-20200319084357652](assets/image-20200319084357652.png)
...
- ![image-20200319084902957](assets/image-20200319084902957.png)
...
![image-20200319085446640](assets/image-20200319085446640.png)
...
![image-20200319090446231](assets/image-20200319090446231.png)
